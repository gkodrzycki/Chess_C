...
void PrintBoard()
{
    ...
    for(int j = 0; j < 8; j++)
    {
        if(j != 7)  printf("%c%c%c", (char)205u, (char)205u, (char)203u);
        else        printf("%c%c%c\n", (char)205u, (char)205u, (char)187u);
    }
    for(int rank = 0; rank < 8; rank++)
    {
        printf("%d %c", 8 - rank, (char)186u);
        for(int file = 0; file < 8; file++)
        {
                 if(Board[rank][file]->Figure != '.')                              printf(" %c%c", Board[rank][file]->Figure, (char)186u);
            else if((rank%2 == 0 && file%2 == 0) || (rank%2 == 1 && file%2 == 1))  printf("%c%c%c", (char)219u, (char)219u, (char)186u);
            else                                                                   printf("  %c", (char)186u);
            i++;
        }
        ...
        if(rank != 7)
        {
            ...
            {
                if(j != 7)
                    printf("%c%c%c", (char)205u, (char)205u, (char)206u);
                else
                    printf("%c%c%c\n", (char)205u, (char)205u, (char)185u);
            }
        }
        else    printf("\n");
    }
    ...
    {
        if(j != 7)
            printf("%c%c%c", (char)205u, (char)205u, (char)202u);
        else
            printf("%c%c%c\n    ", (char)205u, (char)205u, (char)188u);
    }
